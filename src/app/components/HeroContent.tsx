  ...
  return (
    <div className="relative z-10 flex items-center px-8 py-10 text-zinc-100 sm:px-10 lg:px-12">
      <div className="relative z-10 max-w-xl space-y-8">
        <p className="animate-enter text-base font-medium text-zinc-400">
          Frontend Developer
        </p>
        ...
        <div className="animate-enter animate-delay-1 space-y-5">
          ...
          <p className="max-w-lg text-lg leading-8 text-zinc-400">
            I build modern frontend interfaces with a focus on clarity,
            usability, and responsiveness. I work with Blazor, Angular, and
            TypeScript, and I’m currently growing my portfolio and commercial
            frontend experience.
          </p>
        </div>
